...
public class PMIWuliuDao {
	...
	public void insertOnePMIWuliuDoc(Map<String, Object> map) {
		client.getDatabase("autonews").getCollection("pmiWuliu").insertOne(new Document(map));
	}
}
