package com.github.cyl.dao.cxpmi;
...
public class ServicePMIDao {
	...
	public void insertOneServicePMIDoc(Map<String, Object> map) {
		client.getDatabase("autonews").getCollection("cxsvpmi").insertOne(new Document(map));
	}
}
