package com.github.cyl.dao.fcr;
...
public class FCRDao {
	...
	public void insertOneFCRDoc(Map<String, Object> map) {
		client.getDatabase("autonews").getCollection("fcr").insertOne(new Document(map));
	}
}
