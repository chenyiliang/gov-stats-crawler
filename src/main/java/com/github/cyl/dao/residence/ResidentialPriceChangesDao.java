...
public class ResidentialPriceChangesDao {
	...
	public void insertOneRPCDoc(Map<String, Object> map) {
		client.getDatabase("autonews").getCollection("rpc").insertOne(new Document(map));
	}
}
