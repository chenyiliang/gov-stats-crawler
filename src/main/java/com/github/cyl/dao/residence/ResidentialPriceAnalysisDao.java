package com.github.cyl.dao.residence;
...
public class ResidentialPriceAnalysisDao {
	...
	public void insertOneRPADoc(Map<String, Object> map) {
		client.getDatabase("autonews").getCollection("rpa").insertOne(new Document(map));
	}
}
